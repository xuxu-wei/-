...
- 全书按 17 篇、85 章规划；前十三篇的 64 章已交付，共 157 本正式 Notebook（含篇末综合）、52 个章节探索视图与 730 道练习。
- M0—M14 已完成；第 14—17 篇的 21 章为设计导览，下一步实施 M15《数据驱动动力学与模型降阶》。
...
在默认 IDE 中选择项目 `.venv` 作为 Notebook 内核，从[第 1 篇：看见系统](notebooks/01-看见系统/README.md)按目录顺序学习，当前已交付至[第 13 篇：临界变化与韧性](notebooks/13-临界变化与韧性/README.md)。启动本机程序后可打开[开始首页](http://127.0.0.1:8000/)或[全书目录](http://127.0.0.1:8000/catalog/)；环境、操作与故障处理见[学习指南](docs/学习指南.md)。
