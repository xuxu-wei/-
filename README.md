...
- 已完成十二篇、55 章的课程设计；第 1、2 篇提供 20 本正式 Notebook（含篇末综合）、5 张探索页与 86 道练习。
...
在默认 IDE 中选择项目 `.venv` 作为 Notebook 内核，从[第 1 篇：看见系统](notebooks/01-看见系统/README.md)开始，再学习[第 2 篇：系统随时间演化](notebooks/02-系统随时间演化/README.md)。启动本机程序后可打开[网页目录](http://127.0.0.1:8000/)；环境、操作与故障处理见[学习指南](docs/学习指南.md)。
