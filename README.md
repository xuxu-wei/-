...
- 全书按 17 篇、85 章规划；前十一篇的 55 章已交付，共 137 本正式 Notebook（含篇末综合）、46 个章节探索视图与 642 道练习。
- M0—M12 已完成；第 12—17 篇的 30 章为设计导览，下一步实施 M13《个体与集体现象》。
...
在默认 IDE 中选择项目 `.venv` 作为 Notebook 内核，从[第 1 篇：看见系统](notebooks/01-看见系统/README.md)按目录顺序学习，当前已交付至[第 11 篇：网络上的系统](notebooks/11-网络上的系统/README.md)。启动本机程序后可打开[开始首页](http://127.0.0.1:8000/)或[全书目录](http://127.0.0.1:8000/catalog/)；环境、操作与故障处理见[学习指南](docs/学习指南.md)。
