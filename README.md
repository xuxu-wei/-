...
- 全书按 17 篇、85 章规划；前十二篇的 60 章已交付，共 148 本正式 Notebook（含篇末综合）、49 个章节探索视图与 690 道练习。
- M0—M13 已完成；第 13—17 篇的 25 章为设计导览，下一步实施 M14《临界变化与韧性》。
...
- 前十篇篇末综合提供难度递进、首次/练习成绩及分层复习入口；评价规则见[教材设计](docs/教材设计.md#capstone-assessment)。
...
在默认 IDE 中选择项目 `.venv` 作为 Notebook 内核，从[第 1 篇：看见系统](notebooks/01-看见系统/README.md)按目录顺序学习，当前已交付至[第 12 篇：个体与集体现象](notebooks/12-个体与集体现象/README.md)。启动本机程序后可打开[开始首页](http://127.0.0.1:8000/)或[全书目录](http://127.0.0.1:8000/catalog/)；环境、操作与故障处理见[学习指南](docs/学习指南.md)。
