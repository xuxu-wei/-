...
- 全书按 17 篇、85 章规划；前八篇的 39 章已交付，共 102 本正式 Notebook（含篇末综合）、30 张探索页与 480 道练习。
- M0—M9 已完成；第 9—17 篇的 46 章为设计导览，下一步实施 M10《概率建模与近似推断》。
...
- 前八篇篇末综合提供难度递进、首次/练习成绩及分层复习入口；评价规则见[教材设计](docs/教材设计.md#capstone-assessment)。
...
在默认 IDE 中选择项目 `.venv` 作为 Notebook 内核，从[第 1 篇：看见系统](notebooks/01-看见系统/README.md)按目录顺序学习，当前已交付至[第 8 篇：优化方法与计算](notebooks/08-优化方法与计算/README.md)。启动本机程序后可打开[开始首页](http://127.0.0.1:8000/)或[全书目录](http://127.0.0.1:8000/catalog/)；环境、操作与故障处理见[学习指南](docs/学习指南.md)。
